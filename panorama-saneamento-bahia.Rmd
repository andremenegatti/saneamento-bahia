---
title: "Panorama do Saneamento Básico nos Municípios Baianos"
author: "Rudinei Toneto Jr., Bruno Cesar Aurichio Ledo, André Luís Menegatti"
date: "08/06/2020"
output: 
...
```{r mapa-tipo-prestador-agua, fig.cap = "Figura 1", echo = FALSE}
...
```{r mapa-tipo-prestador-esgoto, fig.cap = "Figura 2", echo = FALSE}
...
```{r mapa-atendimento-agua, fig.cap = "Figura 3", echo = FALSE}
...
```{r histograma-atendimento-agua, fig.cap = "Figura 4", echo = FALSE}
knitr::include_graphics("plots/agua/histogram-indice-atendimento-agua.png")
```

```{r boxplot-atendimento-agua, fig.cap = "Figura 5", echo = FALSE}
...
```{r mapa-tarifa-agua, fig.cap = "Figura 6", echo = FALSE}
...
```{r boxplot-tarifa-agua, fig.cap = "Figura 7", echo = FALSE}
...
```{r mapa-coleta-esgoto, fig.cap = "Figura 8", echo = FALSE}
...
```{r barplot-coleta-esgoto, fig.cap = "Figura 9", echo = FALSE}
...
```{r mapa-tratamento-esgoto, fig.cap = "Figura 10", echo = FALSE}
...
```{r barplot-tratamento-esgoto, fig.cap = "Figura 11", echo = FALSE}
...
```{r mapa-tarifa-media-esgoto, fig.cap = "Figura 12", echo = FALSE}
...
```{r histograma-tarifa-esgoto, fig.cap = "Figura 13", echo = FALSE}
...
```{r mapa-investimento, fig.cap = "Figura 14", echo = FALSE}
...
```{r mapa-desempenho, fig.cap = "Figura 15", echo = FALSE}
...
```{r mapa-perdas, fig.cap = "Figura 16", echo = FALSE}
...
```{r histograma-perdas, fig.cap = "Figura 17", echo = FALSE}
...
```{r corr-plot-agua, fig.cap = "Figura 18", echo = FALSE}
...
```{r corr-plot-agua-esgoto, fig.cap = "Figura 19", echo = FALSE}
...
```{r scatterplot-atendimento-agua-vs-pib-per-capita, fig.cap = "Figura 20", echo = FALSE}
knitr::include_graphics("plots/agua/scatterplot-atendimento-agua-vs-pib-per-capita.png")
```

```{r scatterplot-tarifa-agua-vs-pib-per-capita, fig.cap = "Figura 21", echo = FALSE}
knitr::include_graphics("plots/agua/scatterplot-tarifa-agua-vs-pib-per-capita.png")
```

```{r scatterplot-tarifa-vs-coleta-esgoto, fig.cap = "Figura 22", echo = FALSE}
knitr::include_graphics("plots/esgoto/scatterplot-tarifa-vs-coleta-esgoto.png")
```

```{r scatterplot-tarifa-vs-tratamento-esgoto, fig.cap = "Figura 23", echo = FALSE}
...
highlights_agua <- readRDS('data/highlights_agua.rds') %>% 
  select(`Posição` = ranking, `Município` = municipio, `Pontuação` = score, `Tipo de prestador` = tipo_prestador,
         `População (2017)` = populacao, Atendimento = atendimento, `Tarifa de água` = tarifa_agua,
         `Perdas` = perdas, `Invest. per capita` = inv_per_capita, `Desempenho financeiro` = desempenho)

highlights_agua %>% slice(1:10) %>% knitr::kable()
```

Por sua vez, a tabela a seguir apresenta os dados dos 10 municípios que obtiveram os piores resultados:

```{r, echo = FALSE}
highlights_agua %>% arrange(desc(`Posição`)) %>% slice(1:10) %>% knitr::kable()
```

O gráfico abaixo apresenta a distribuição das pontuações obtidas pelos municípios:

```{r fig.cap = "Figura 24", echo = FALSE}
...
highlights_agua_esgoto <- readRDS('data/highlights_agua_esgoto.rds') %>% 
  select(`Posição` = ranking, `Município` = municipio, `Pontuação` = score, `Tipo de prestador` = tipo_prestador,
         `População (2017)` = populacao, Atendimento = atendimento, `Coleta` = coleta, `Tratamento` = tratamento,
         `Tarifa de água` = tarifa_agua, `Tarifa de esgoto` = tarifa_esgoto,
         `Perdas` = perdas, `Invest. per capita` = inv_per_capita, `Desempenho financeiro` = desempenho)

highlights_agua_esgoto %>% slice(1:10) %>% knitr::kable()
```

Por sua vez, a tabela a seguir apresenta os dados dos 10 municípios que obtiveram os piores resultados:

```{r, echo = FALSE}
highlights_agua_esgoto %>% arrange(desc(`Posição`)) %>% slice(1:10) %>% knitr::kable()
```

O gráfico abaixo apresenta a distribuição das pontuações obtidas pelos municípios:

```{r fig.cap = "Figura 25", echo = FALSE}
